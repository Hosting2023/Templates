...
import type { InitFormikValuesResetPassword } from '@/components/Registration/resetPassword/form-model/reset-password.interfaces';
import type { InitFormikValuesSignIn } from '@/components/Registration/logIn/form-model/sign-in.interfaces';
import type {
  InitFormikValues,
  InitFormikValuesGetVerifyCode,
} from '@/components/Registration/signUp/form-model/sign-up.interfaces';
