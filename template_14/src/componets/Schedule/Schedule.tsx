...
const Schedule: FC<{ OpenModal: any, valueVisit: any }> = ({ OpenModal, valueVisit }) => {
   ...
   return (<div className={`${styles.schedule} ${valueVisit == null ? styles.nonactive : ''}`} id="schedule">

      <div className={`${styles.wrapper} wrapper`}>
         <div className={styles.schedule_content}>
            <div className={styles.schedule_title_block}>
               <div className={styles.schedule_block_square}>
               </div>
