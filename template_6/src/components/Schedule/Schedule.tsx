  ...
  return (
    <div className={styles.schedule_page} id={t('nav_schedule')}>
      <div className={styles.schedule_content}>
        <div className={styles.schedule_content_left}>
          <Image
            src={scheduleSvg}
            alt={'Schedule img'}
            className={styles.schedule_content_left_img}
          />
        </div>
        <div
          className={
        ...
        >
          <h1 className={styles.schedule_header}>{t('schedule_title')}</h1>
      ...
      {modalOpened ? (
        <AuthentificationModal setModalOpened={setModalOpened} />
      ) : (
        ''
      )}
    </div>
