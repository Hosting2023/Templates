...
const Filter: FC<FilterProps> = () => {
  ...
  return (
    <div className={styles.filter_page} id={t("nav_filter")}>
      <h1 className={styles.filter_header}>{t("filter_title")}</h1>
      <div className={styles.filter_content}>
        <div className={styles.filter_content_left}>
          ...
          <div className={styles.filter_block_wrapper}>
            ...
            <div className={styles.filter_block_btn_wrapper}>
              {filters[0]?.filterItems.map((item, idx) => (
                <button
                  className={
                    activeAllergy === idx ? styles.filter_block_btn_active : styles.filter_block_btn
                  }
                  key={idx}
                  onClick={() => {
          ...
          {activeFrequency === 0 ? (
            <div className={styles.filter_block_wrapper}>
              ...
              <div className={styles.filter_block_btn_wrapper_clean}>
        ...
        <div className={styles.filter_content_right}>
          ...
          <textarea
            placeholder={t("filter_enter")}
            className={styles.filter_content_right_textarea}
          ></textarea>
