...
function ModalSignUp() {
  ...
  return (
    <div className={styles.content_singup}>
      ...
      {page === 1 ? (
        <ModalPage1 handleNextPage={handleNextPage} />
      ) : (
        <ModalPage2 handleSend={handleSend} />
      )}
    </div>
  );
}
...
const ModalPage1 = ({ handleNextPage }: any) => {
  ...
  return (
    <div className={styles.form}>
      ...
      <div className={styles.block_date}>
        ...
        <div className={styles.date} onClick={() => setCalendar(!calendar)}>
          ...
          <div className={styles.img}>
            {dateError ? (
              <div className={styles["error-message"]}>{dateError}</div>
            ) : (
      ...
      <button className={styles.button} onClick={handleNextPages}>
        Next
      </button>
    </div>
  );
        ...
        {days.map((day, index) => (
          <div
            ...
            className={`${styles["date-box"]} ${
              day.toDateString() === currentDate.toDateString() ? styles["today"] : ""
            }`}
          >
