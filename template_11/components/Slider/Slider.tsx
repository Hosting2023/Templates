...
import arrow from "@/public/arrow-br.svg";
import arrow_gray from "@/public/arrow_gray.svg";
   ...
   useEffect(() => {
      const handleResize = () => {
         ...
         if (typeof window !== 'undefined') {
            const newMaxVisibleSlides = isChangeVisibleSlide && window?.innerWidth < 1000 ? 1 : 2;
