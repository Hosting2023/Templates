...
import { fetchCreateOrder, useAppDispatch } from "@hosting2023/redux-lib";
  ...
  return (
    <div className={styles.schedule}>
      <div className={styles.container}>
        ...
        <Numbers />
        <TimeSection
          setDisabledButton={setIsDisabledButton}
        ...
        <DialogWindow
          title="To order please login or register"
          currentComponentParam="toOrder"
          isOpen={dialogOpen}
          onClose={closeDialog}
        />
      </div>
